...
<CardGroup cols={2}>
  <Card title="th0th_index" icon="folder-tree" href="/api/tools-reference#th0th_index">
    Index a project directory for semantic search
  </Card>
  <Card title="th0th_index_status" icon="hourglass-half" href="/api/tools-reference#th0th_index_status">
    Check background indexing job progress
  </Card>
  <Card title="th0th_search" icon="magnifying-glass" href="/api/tools-reference#th0th_search">
    Semantic + keyword search with filters
  </Card>
  <Card title="th0th_remember" icon="brain" href="/api/tools-reference#th0th_remember">
    Store information in persistent memory
  </Card>
  <Card title="th0th_recall" icon="clock-rotate-left" href="/api/tools-reference#th0th_recall">
    Search stored memories from previous sessions
  </Card>
  <Card title="th0th_compress" icon="compress" href="/api/tools-reference#th0th_compress">
    Compress context (keeps structure, removes details)
  </Card>
  <Card title="th0th_optimized_context" icon="gauge-high" href="/api/tools-reference#th0th_optimized_context">
    Search + compress in one call (max token efficiency)
  </Card>
  <Card title="th0th_analytics" icon="chart-line" href="/api/tools-reference#th0th_analytics">
